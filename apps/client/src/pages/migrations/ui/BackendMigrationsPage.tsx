    ...
    <div className="max-w-4xl">
      <div className="mb-12">
        ...
        <p className="text-lg text-neo-text-muted">
          Explore the fully supported migration paths for your backend architecture. Metamorph currently allows automated, secure migrations between <strong className="text-white">Express</strong>, <strong className="text-white">Fastify</strong>, and <strong className="text-white">NestJS</strong>. Select your current technology stack below to view available target frameworks.
        </p>
      </div>
